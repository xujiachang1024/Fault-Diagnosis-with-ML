...
% load the CWRU data set, load=3HP, and average EEMD feature #5
...
% load the CWRU data set, load=3HP, and average EEMD feature #6
...
% load the CWRU data set, load=3HP, and average frequency-domain feature #14
