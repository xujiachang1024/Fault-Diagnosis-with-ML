...
Z = 5;
M = 700;
F_stacked = zeros((Z + 1) * 3, M * 2);
T_stacked = zeros(7, M * 2);

% load the CWRU data set, load=1HP & load=2HP, and stack EEMD feature #5
...
% load the CWRU data set, load=1HP & load=2HP, and stack EEMD feature #6
...
% load the CWRU data set, load=1HP & load=2HP, and stack frequency-domain feature #14
