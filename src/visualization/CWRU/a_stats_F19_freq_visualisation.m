...
for z=1:Z
    ...
    title(strcat('CWRU subset A: Statistical F19, z=', num2str(0.5 * (z - 1))));
    xlabel('Sample point');
    ylabel('F19');
    legend('Class 1', 'Class 2', 'Class 3', 'Class 4', 'Class 5', 'Class 6', 'Class 7', 'Location', 'northeastoutside');
    saveas(fig, strcat('reports/figures/CWRU_features/CWRU_stats_F19_z', z_score(z*2-1:z*2), '.png'));
end
...
title('CWRU Data: Freq-Domain Feature #19, median');
xlabel('Sample point');
ylabel('F1');
legend('Normal', 'OR 014', 'IR 007', 'IR 014', 'IR 021', 'IR 028', 'B 014', 'Location', 'northeastoutside');